...
class XScreen(State):
    ...
    def __init__(self, screen):
        ...
        self.name = "A - IntroState"
        self.description = "Playback of the Logos and stuff"
        logging.debug('init A screen')

        # A whole Block just to display the Text ...
        self.font1 = pygame.font.SysFont("Monospaced", size1)
        self.font2 = pygame.font.SysFont("Monospaced", size2)
        # Render the text
        ...
        self.text3Rect.centery = self.screen.get_rect().centery+30
